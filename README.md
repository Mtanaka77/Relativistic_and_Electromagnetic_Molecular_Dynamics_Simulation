...
In the major subroutine /moldyn/, (i) the magnetic field is advanced,  
(ii) current density and the tranverse electric field is advanced, 
(iii) the correction of the longitudinal electric field is made, 
(iv) the longitudinal electric field is added, 
(v) the forces are calculation, 
and (vi) positions and momenta are assined to particles toward the next time step.
