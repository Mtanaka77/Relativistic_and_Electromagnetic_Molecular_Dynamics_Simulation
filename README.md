...
The operation of each subroutine or some lines of the code such as, for example,  @a_cnt3-3p8Ca.f03 and @3ddisppC.f03, are written as comments of the simulation and post-script programs.
