...
This page is discussed on the relativistic and nanoscale molecular dynamics simulations, Computer Physics Communications (2019, Ref. 1). Updated files of @cnt3em_05Aa.f03, parameters and configuration files are uploaded which are dated of Sep. 2024.
