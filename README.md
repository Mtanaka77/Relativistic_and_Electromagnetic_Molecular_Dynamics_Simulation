...
Two different fortrans, PGI and gfotran, are incompatible with processors of the s One may want to use about 50 processors at least, where the Z-dimension is exactly divided by parallelization. ame name but different styles.
