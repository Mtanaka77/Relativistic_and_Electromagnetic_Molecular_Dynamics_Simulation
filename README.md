...
To analyze simulation results, some programs are provided here as post processing. They are @3dfdisp.f03 and
@3ddisp.f03, as examples. The velocity distributions in parallel and perpendicular directions are plotted in sequential 
time of ions and electrons. The @3dfdisppC.f03 program is time sequential plots of H, C, Au and electrons in side and top views.
