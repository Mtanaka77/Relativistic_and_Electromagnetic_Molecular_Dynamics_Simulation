...
The operation of each subroutine or some lines of such as, for example,  @a_cnt3-3p8Ca.f03 and @3ddisppC.f03 which is shown later, are written as comments of the simulation code and post-script programs. Initial 70 lines of @cnt3-3p8Ca.f03 are devoted to the title and remarks of the code.
