...
!                                                                    !
!  Files are:                                                        !
!  1. @a_cnt3-3p8Cz.f03: Molecular dynamics simulation code          !
!  2. param_em3p8_Cz.h: Common parameters of this simulation         !
!  3. Cntemz_config.STARTC: Configure parameters                     !
...
!  * The parallel simulation for now is coded for one-dimensional    !
!   case in MPI v.3.                                                 !
!                                                                    !
...
!
      ...
      implicit  none
!
      include   'param_em3p8_Cz.h'  ! <- parameter file
      include   'mpif.h'
!
...
!
      ...
      igrp = kgrp
!
      if(iflinx) then    ! 27 + 6= 33  sname='Cntemp' in param_em3p8_Cz.h
...
!
      include 'param_em3p8_Cz.h'
      include 'fftw3.f03'     ! general case
...
!
      call mpi_allreduce (xyz(1,1),qqq(1,1),npq0,mpi_double_precision,mpi_sum, &
                          mpi_comm_world,ierror)
      call mpi_allreduce (xyz(1,2),qqq(1,2),npq0,mpi_double_precision,mpi_sum, &
                          mpi_comm_world,ierror)
      call mpi_allreduce (xyz(1,3),qqq(1,3),npq0,mpi_double_precision,mpi_sum, &
                          mpi_comm_world,ierror)
!
      do i= 1,npq0
      xyz(i,1)= qqq(i,1)
