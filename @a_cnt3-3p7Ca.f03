!*--------------------------------------------------------------------*
!  @cnt3ems_07Ca.f03                    Dec.24, 2016, Sep.13, 2024    !   
!                                                                     !
...
!
      if(iflinx) then 
        ...
        praefixs = '/home/tanakam/cntem3/'//sname
...
!
!
!  Don't apply to the explicit code !!
...
!
   ...
   62   end do
!
!  In the FFTW space of correction delta.q
!  allgather: qx( ,nw) into qq( ,n), always in mza, not full mz
...
!
        if(ionode .and. iwrt1.eq.0) then  !<-- hurry check
...
!
      integer*4     it,is,k,k1,ionode,wrt
      common/parm1/ it,is
!
...
!
      if(ionode) then
        write(wrt,*) 'Rehist: new is, dtwr=',is,dtwr
      end if
!
      return
