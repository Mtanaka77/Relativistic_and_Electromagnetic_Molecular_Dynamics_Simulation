!*--------------------------------------------------------------------*
!  @a_cnt3-3p9Ca.f03                    Dec.24, 2016, Sep.23, 2024    !   
!                                                                     !
...
!
      ...
      implicit  none
!
      include   'param_em3p7_Ca.h'  ! <- parameter file
      include   'mpif.h'
!
...
!
      ...
      igrp = kgrp
!
      if(iflinx) then    ! 27 + 6= 33  sname='Cntemp' in param_em3p7_Ca.h
...
!
      etx(l,m,nw)= etx(l,m,nw)                               &
                  ...
                  -p4dt*cjx(l,m,nw)/dV  !!! cjx( ,n) is full size
